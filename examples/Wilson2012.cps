...
<!-- generated with COPASI 4.26 (Build 213) (http://www.copasi.org) at 2019-08-12T14:48:46Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_41" name="er" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Function_41">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_289" name="d0" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_288" name="R" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_291" name="E" order="2" role="substrate"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_43" name="es" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_43">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_297" name="f" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_281" name="E" order="1" role="product"/>
        <ParameterDescription key="FunctionParameter_295" name="T" order="2" role="modifier"/>
        <ParameterDescription key="FunctionParameter_299" name="c3" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_301" name="B" order="4" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_44" name="tgfb" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_44">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_287" name="a1" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_284" name="T" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_290" name="c2" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_45" name="tg" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_45">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_305" name="a0" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_304" name="T" order="1" role="product"/>
        <ParameterDescription key="FunctionParameter_307" name="c0" order="2" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_46" name="imm" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_46">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_318" name="d0" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_311" name="E" order="1" role="modifier"/>
        <ParameterDescription key="FunctionParameter_316" name="T" order="2" role="substrate"/>
        <ParameterDescription key="FunctionParameter_320" name="c1" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_322" name="B" order="4" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_47" name="induced" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_47">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_282" name="d0" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_296" name="T" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_283" name="V" order="2" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_0">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000393"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5528" name="a0" value="0.1946"/>
          <Constant key="Parameter_5524" name="c0" value="0.00271003"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4980" name="d0" value="1e-05"/>
          <Constant key="Parameter_3141" name="c1" value="100"/>
        </ListOfConstants>
        <KineticLaw function="Function_46" unitType="Default" scalingCompartment="CN=Root,Model=Wilson2012 - tumor vaccine efficacy,Vector=Compartments[tme]">
          <ListOfCallParameters>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4761" name="d0" value="1e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_47" unitType="Default" scalingCompartment="CN=Root,Model=Wilson2012 - tumor vaccine efficacy,Vector=Compartments[tme]">
          <ListOfCallParameters>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000393"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8423" name="a1" value="0.3"/>
          <Constant key="Parameter_5486" name="c2" value="300"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8409" name="k1" value="0.0007"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_5">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000393"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8917" name="f" value="0.62"/>
          <Constant key="Parameter_3725" name="c3" value="300"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8897" name="k1" value="1e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Wilson2012 - tumor vaccine efficacy,Vector=Compartments[tme]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_7">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8420" name="d0" value="1e-05"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_9">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4978" name="k1" value="1e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Wilson2012 - tumor vaccine efficacy,Vector=Compartments[tme]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_10">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:sbo:SBO:0000179"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_8448" name="k1" value="1e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Wilson2012 - tumor vaccine efficacy,Vector=Compartments[tme]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2019-08-12T11:19:27Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
